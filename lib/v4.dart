...
class _CanvasPaintingState extends State<CanvasPainting> {
  ...
  Future<void> _save() async {
    ...
    if (byteData != null) {
      ...
      // Basit bir kaydetme mesajı göster (gerçek kaydetme için ek paketler gerekir)
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Resim kaydedildi! (PNG formatında)")),
      );
      
      print("Resim kaydedildi: ${pngBytes.length} bytes");
    }
  }
        ...
        body: GestureDetector(
          ...
          child: RepaintBoundary(
            ...
            child: Stack(
              children: <Widget>[
                Center(
                  child: Image.asset("assets/images/hs_limon.png"),
                ),
                CustomPaint(
                  size: Size.infinite,
                  painter: MyPainter(
